...
// Exact same functionality as original function
...
// passing ordinary function not std::function
template <typename R, typename... Args>
...
int main()
{
    // Logger logger{[]() { cout << "Hello" << endl; }, "Testing"};
    // auto logger = make_Logger2([](){ cout << "Hello" << endl; }, "Testing");
    auto logged_add = make_logger3(add, "Add");
    auto result = logged_add(2,3);

    // logger();
    // cout << logger.name<< endl;
